...
npm test                 # Karma + Jasmine — 1650 tests
npm run e2e              # playwright test — suite completa (incluye capturas y diagnósticos)
npm run e2e:functional   # gate funcional de escritorio (223 tests) en una sola pasada — config propia
