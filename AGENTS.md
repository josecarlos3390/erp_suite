...
npm test                 # jest — 174 suites / 2031 tests
npm run test:watch       # jest --watch
npm run test:cov         # jest --coverage
npm run test:e2e         # jest E2E — 24 suites / 171 tests (sincroniza antes la BD de tests)
