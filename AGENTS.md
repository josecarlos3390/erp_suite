...
| `docs/plans/` | Planes de trabajo activos | `plan-consistencia-visual-v2.md`, `plan-mejoras-ux-ui-frontend.md`, `plan-g3-produccion.md` (plan del módulo de Producción: **aprobado el 2026-09-19**, con la **Fase 1 implementada**) |
...
npm test                 # jest — 178 suites / 2087 tests
npm run test:watch       # jest --watch
npm run test:cov         # jest --coverage
npm run test:e2e         # jest E2E — 25 suites / 182 tests (sincroniza antes la BD de tests)
...
npm test                 # Karma + Jasmine — 1789 tests
