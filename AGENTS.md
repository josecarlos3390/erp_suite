...
| `docs/plans/` | Planes de trabajo activos | `plan-consistencia-visual-v2.md`, `plan-mejoras-ux-ui-frontend.md`, `plan-g3-produccion.md` (plan del módulo de Producción: **aprobado el 2026-09-19**, con las **Fases 1, 2 y 3 implementadas**) |
...
npm test                 # jest — 180 suites / 2113 tests
npm run test:watch       # jest --watch
npm run test:cov         # jest --coverage
npm run test:e2e         # jest E2E — 27 suites / 203 tests (sincroniza antes la BD de tests)
...
npm test                 # Karma + Jasmine — 1807 tests
