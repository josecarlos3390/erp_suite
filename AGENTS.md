...
| `npm run lint` | ✅ **OK** | 0 errores, 0 warnings |
| `npx ng test --watch=false --browsers=ChromeHeadlessCI` | ✅ **OK** | **1648 / 1648 tests** (los 1647 del cierre de T126–T129/F5.6/F5.7 + el test de **T133** que fija que el constructor de consultas usa `luna-select` con las opciones no operables deshabilitadas) |
