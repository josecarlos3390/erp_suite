...
npm test                 # jest — 182 suites / 2157 tests
npm run test:watch       # jest --watch
npm run test:cov         # jest --coverage
npm run test:e2e         # jest E2E — 30 suites / 229 tests (sincroniza antes la BD de tests)
...
npm test                 # Karma + Jasmine — 1931 tests
