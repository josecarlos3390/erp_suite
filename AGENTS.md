...
npm test                 # jest — 182 suites / 2153 tests
npm run test:watch       # jest --watch
npm run test:cov         # jest --coverage
npm run test:e2e         # jest E2E — 30 suites / 227 tests (sincroniza antes la BD de tests)
...
npm test                 # Karma + Jasmine — 1927 tests
