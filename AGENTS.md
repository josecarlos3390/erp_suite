...
| `docs/plans/` | Planes de trabajo activos | `plan-consistencia-visual-v2.md`, `plan-mejoras-ux-ui-frontend.md`, `plan-g3-produccion.md` (plan del módulo de Producción: **aprobado el 2026-09-19**, con las **Fases 1–4 implementadas**) |
...
npm test                 # jest — 181 suites / 2126 tests
npm run test:watch       # jest --watch
npm run test:cov         # jest --coverage
npm run test:e2e         # jest E2E — 28 suites / 211 tests (sincroniza antes la BD de tests)
...
npm test                 # Karma + Jasmine — 1817 tests
