...
npm test                 # jest — 174 suites / 2029 tests
npm run test:watch       # jest --watch
npm run test:cov         # jest --coverage
npm run test:e2e         # jest E2E — 22 suites / 156 tests (sincroniza antes la BD de tests)
...
npm test                 # Karma + Jasmine — 1763 tests
