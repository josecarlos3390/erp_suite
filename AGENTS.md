...
npm test                 # jest — 184 suites / 2205 tests
npm run test:watch       # jest --watch
npm run test:cov         # jest --coverage
npm run test:e2e         # jest E2E — 32 suites / 259 tests (sincroniza antes la BD de tests)
