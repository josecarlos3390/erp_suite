...
npm test                 # jest — 183 suites / 2187 tests
npm run test:watch       # jest --watch
npm run test:cov         # jest --coverage
npm run test:e2e         # jest E2E — 31 suites / 251 tests (sincroniza antes la BD de tests)
...
npm test                 # Karma + Jasmine — 1991 tests
