...
npm test                 # jest — 172 suites / 1986 tests
npm run test:watch       # jest --watch
npm run test:cov         # jest --coverage
npm run test:e2e         # jest E2E — 21 suites / 139 tests (sincroniza antes la BD de tests)
...
npm test                 # Karma + Jasmine — 1699 tests
npm run e2e              # playwright test — suite completa (incluye capturas y diagnósticos)
npm run e2e:functional   # gate funcional de escritorio (230 tests) en una sola pasada — config propia
