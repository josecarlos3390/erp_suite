...
npm test                 # jest — 185 suites / 2217 tests
npm run test:watch       # jest --watch
npm run test:cov         # jest --coverage
npm run test:e2e         # jest E2E — 33 suites / 265 tests (sincroniza antes la BD de tests)
...
npm test                 # Karma + Jasmine — 1996 tests
