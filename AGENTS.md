...
> **Última actualización:** 2026-09-18 (T145 cerrado —la NC parcial de importes impares cuadra al céntimo—, T146 cerrado por su causa real —el arnés E2E fechaba con el día UTC—, **T147** cerrado con la opción elegida por el usuario (el par revertido se netea en el cuadre del informe, así que la fecha de contabilización de una anulación deja de importar para cuadrar) y **T148** cerrado con la unificación coherente del `isReserve` (la pantalla también pide F. Reserva al facturar desde una entrega, identificada explícitamente en UI, payload, serie y vínculo); **T149 declarado** —elegir la fecha de contabilización de una anulación—; matriz de flujos en `docs/reference/matriz-flujos-documentos.md`).
...
npm test                 # jest — 171 suites / 1974 tests
...
npm test                 # Karma + Jasmine — 1686 tests
