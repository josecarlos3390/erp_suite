...
| `npm run lint` | ✅ **OK** | 0 errores, 0 warnings |
| `npx ng test --watch=false --browsers=ChromeHeadlessCI` | ✅ **OK** | **1594 / 1594 tests** (los 1566 documentados el 2026-09-12 + los del cierre de T126/T127/T128: el medio centavo del importe negativo en `money.util`, los 2 nuevos del mapper de factura desde pedido —la cadena del almacén— y el resto de frentes de ese día) |
