...
| `npm run lint` | ✅ **OK** | 0 errores, 0 warnings |
| `npx ng test --watch=false --browsers=ChromeHeadlessCI` | ✅ **OK** | **1601 / 1601 tests** (los 1566 documentados el 2026-09-12 + los del cierre de T126/T127/T128/T129: el medio centavo del importe negativo en `money.util`, los 2 del mapper de factura desde pedido —la cadena del almacén—, los 6 de la puerta «Copiar a → Factura de Compra» de la recepción y el del payload real `purchaseReceiptItemId`) |
