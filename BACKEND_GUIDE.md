...
| 2 | **Totales persistidos** (journal builders, facturas, FRV, devoluciones/NC) | 🔄 **en curso**: **redondeo manual cerrado (R2b = 0**, con 3 justificaciones de porcentaje**)** con `scripts/migrate-round-money.mjs` y la aritmética ya migrada en `document-totals.util`, `payment-term.util`, `rc-iva`, `iue`, `delivery-orders`, `price-lists`, `price-resolver`, `purchase-invoices`, `sale-reserve-invoices`, `sale-invoices`, `reports`, `accounts`, `partners`, las **cuatro notas** (`sales`/`purchase` × débito/crédito) y los restos de la corrección del detector (`document-drafts`, `fixed-assets`, `discount-cost.util`). **Frente abierto: 47** (R2a **39** + R2c **8**), por criticidad: `bank-reconciliation` (6), `sales.journal-builder` (6), `purchase-orders` (5), `sales-orders` (4), `purchase-requests` (3), `purchase-quotations`/`sales-quotations` (2+2), `drafts.journal-builder` (1 + 3 R2c), `items` (2 + 1 R2c), `incoming-payments` (1 + 2 R2c), `outgoing-payments` (2 R2c), `purchases.journal-builder` (2), `fiscal-years` (2), `banks` (1), `pos-sessions` (1), `notes`/`deliveries` pequeños |
