...
### G3 — Módulo de Producción (potenciar) ✅ RESUELTO (2026-09-20) · Prioridad MEDIA

> **Plan y decisiones: `plan-g3-produccion.md`** (2026-09-19, aprobado por el usuario; **siete fases
...
> de receta y ruta, estados reversibles y costo previsto congelado, la **emisión para producción** que carga
> el consumo al **WIP** (Dr WIP / Cr Inventario), el **recibo para producción** que ingresa el PT, los
> subproductos y la merma absorbiendo ese WIP y el **consumo de recursos** (partes de horas con el snapshot
> de los componentes de costo del recurso y Dr WIP / Cr cuenta del componente, con el tiempo real de la
> operación) el **cierre** que liquida el WIP a cero contra la cuenta de variación (con su reapertura, los
> reportes de costo/WIP/desviaciones **en pantalla con exportación** y el detector R16) y el **E2E de UI
> del ciclo completo**, con el `AssemblyOrder` intacto) con la
