...
### G3 — Módulo de Producción (potenciar) 🚧 FASE 1 IMPLEMENTADA (2026-09-19) · Prioridad MEDIA

> **Plan y decisiones: `plan-g3-produccion.md`** (2026-09-19, aprobado por el usuario; **Fase 1 ya
> implementada y verificada**: centros de trabajo, recursos con componentes de costo, rutas por artículo,
> receta multinivel con merma y **explosión con aviso de faltantes**, con el `AssemblyOrder` intacto) con la
