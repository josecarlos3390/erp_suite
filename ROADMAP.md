...
*Última actualización: 2026-09-08 (G5: doc canónica al día — módulos contables cierre de período, revaluación por TC, conciliación bancaria y activos fijos marcados como existentes; AGENTS.md §5.7 filas 8–11 y §8 actualizados; features pendientes F7.2 → ✅. Gaps de producto y deuda: ver `docs/plans/plan-gaps-deuda-2026-09.md`)*
