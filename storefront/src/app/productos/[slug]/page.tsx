    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-start">
        ...
        <div className="flex flex-col gap-4 lg:sticky lg:top-32">
          ...
          {/* F6/T228: servicio tecnico. El canal dice si la publicacion tiene vendedor
              (`canRequestService`), que es quien atiende la solicitud; sin vendedor no se
              ofrece el formulario en vez de prometer algo que nadie atiende. */}
          {product.canRequestService === true ? (
            <ServiceRequestForm
              slug={product.slug}
