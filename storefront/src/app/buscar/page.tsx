...
export async function generateMetadata({
  ...
  const title =
    query === undefined ? "Buscar productos" : `Resultados para "${query}"`;
  return {
    title,
    description:
      query === undefined
      ...
      <div className="flex flex-col gap-6">
        ...
        <header className="flex flex-col gap-1">
          ...
          <p className="text-sm text-fg-secondary">
            Escribe lo que buscas en el buscador de arriba (nombre, marca o
            SKU).
          </p>
        </header>
        ...
        <EmptyState
          ...
          actions={[
            {
              href: "/categorias",
              label: "Recorrer todas las categorias",
              primary: true,
            },
