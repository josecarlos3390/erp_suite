...
S4, S5, S6, S7, S8, S9, S10, S11, S12, S13, S14 y S15 resueltos (2026-08-08/09).** Todos los
...
pagos, multi-moneda de pagos, trazabilidad por lote en tomas), y la información faltante P1 quedó
resuelta (costo promedio informativo en artículos, reactivación de partners/items, tabs de
Direcciones y Cuentas Bancarias en el partner-detail). **La deuda estructural priorizada y las
auditorías UX completas están liquidadas.** Quedan solo excepciones cosméticas documentadas
(alturas 28px/38px intencionales y decorativas que no pertenecen al token de control) y el bloque
P1 restante (saldo/stock en listados, disponibilidad de lotes, cuentas de ingreso/gasto en
artículos, trazabilidad SERIAL en tomas — todos requieren backend medio/migración).
