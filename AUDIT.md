...
S4, S5, S6, S7, S8, S9, S10, S11, S12 y S13 resueltos (2026-08-08).** Todos los formularios de
...
la pestaña y la página (columnas, resumen, badge, 0 vs null, hint de promedio filtrado), y el copy
de formularios comerciales quedó unificado (tildes, iconos LUNA, labels de referencia, títulos,
toasts y botones de crear). **La deuda estructural priorizada y la auditoría UX completa (bloques
A-D) están liquidadas.** Quedan solo excepciones cosméticas documentadas (alturas 28px/38px
intencionales y decorativas que no pertenecen al token de control).
