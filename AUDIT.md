...
S4, S5 y S6 resueltos (2026-08-08).** Todos los formularios de documentos usan el patrón
canónico, el helper de testing refleja las APIs reales, las alturas de control usan tokens LUNA,
y el Plan de Cuentas muestra todas las cuentas con totalización por nivel (POSTED por defecto,
DRAFT opcional como proyección). **La deuda estructural priorizada está liquidada.** Quedan solo
