...
S4, S5, S6, S7, S8, S9 y S10 resueltos (2026-08-08).** Todos los formularios de documentos usan
el patrón canónico, el helper de testing refleja las APIs reales, las alturas de control usan
...
muestra la valorización completa, y los bugs funcionales de formularios comerciales detectados en
la auditoría UX (proveedor/ítems/trazabilidad en devolución de compra, almacén de entrega,
validación de socio en asientos) están corregidos. **La deuda estructural priorizada está
