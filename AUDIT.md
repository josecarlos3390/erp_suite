...
S4 y S5 resueltos (2026-08-08).** Todos los formularios de documentos usan el patrón canónico,
el helper de testing refleja las APIs reales, y las alturas de control usan tokens LUNA
(`--size-control-sm/md/lg`). **La deuda estructural priorizada está liquidada.** Quedan solo
