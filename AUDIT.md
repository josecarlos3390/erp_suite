...
determinación de cuentas jerárquica, branch↔warehouse consistente) están sólidos. **S1, S2, S6,
S3 y S4 resueltos (2026-08-08).** Todos los formularios de documentos ya extienden el patrón
canónico y el helper de testing refleja las APIs reales de los servicios (sin mocks que pasen
falsy ni API desalineada). Resta S5 (tokens LUNA, backlog cosmético).
