...
S4, S5, S6, S7, S8, S9, S10, S11, S12, S13 y S14 resueltos (2026-08-08/09).** Todos los
...
borrador, el kardex del detalle del artículo muestra la valorización completa y el resumen
(paridad con la página completa), los bugs funcionales de formularios comerciales están
corregidos, la coherencia contable/moneda quedó unificada (estado de cuenta en moneda base,
montos en el listado de asientos, bloqueo de períodos cerrados, preview cuadrado en base,
etiquetas de moneda dinámicas), el kardex es consistente entre la pestaña y la página, el copy de
formularios comerciales quedó unificado, y los bugs funcionales P0 de la segunda auditoría
(borradores que "Ver" convertía, badge de guías, pestaña vacía de pagos, multi-moneda de pagos con
exchangeRate, y trazabilidad por lote en tomas de inventario) quedaron corregidos. **La deuda
estructural priorizada y las auditorías UX completas están liquidadas.** Quedan solo excepciones
cosméticas documentadas (alturas 28px/38px intencionales y decorativas que no pertenecen al token
de control, y trazabilidad SERIAL en tomas de inventario pendiente de migración de schema).
