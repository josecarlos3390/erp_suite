...
26. **Trazabilidad de precio en documentos logísticos: desglose bruto → descuento → neto en el detalle** (`frontend / display`) — `✅ Resuelto` (2026-08-13)
   ...
   - **Cobertura:** Frontend build/lint OK + 32 tests (4 forms logísticos). Fix visual puro: la API, los asientos y los totales no cambian (el detalle usa priceNet/discountTotal ya almacenados; el bloque de totales sigue mostrando solo "Costo total").
